<template>
              ...
              <form @submit.prevent="generateReport">
                <div class="row">
                  <div class="col-md-4 mb-3">
                    ...
                    <div class="invalid-feedback" v-if="formSubmitted && !formData.jenis">
                  ...
                  <div class="col-md-4 mb-3" v-if="formData.jenis === 'bulanan'">
                    ...
                    <div class="invalid-feedback" v-if="formSubmitted && formData.jenis === 'bulanan' && !formData.periode">
                  ...
                  <div class="col-md-4 mb-3" v-if="formData.jenis === 'departemen'">
                    ...
                    <div class="invalid-feedback" v-if="formSubmitted && formData.jenis === 'departemen' && !formData.periode">
                      Silahkan pilih periode
                    </div>
                  </div>
                  <div class="col-md-4 mb-3" v-if="formData.jenis === 'departemen'">
                    ...
                    <div class="invalid-feedback" v-if="formSubmitted && formData.jenis === 'departemen' && !formData.departemen">
                  ...
                  <div class="col-md-4 mb-3" v-if="formData.jenis === 'rekap'">
                    ...
                    <div class="invalid-feedback" v-if="formSubmitted && formData.jenis === 'rekap' && !formData.tahun">
  ...
  import { formData, formSubmitted, validate } from './form'
  ...
  function generateMonthlyReport() {
    const payrollId = parseInt(formData.value.periode.toString());
