<template>
            ...
            <div class="card-body">
              <form @submit.prevent="loadEmployeeList">
                ...
                <div class="d-flex justify-content-end mt-4">
                  <button type="submit" class="btn btn-primary" :disabled="!formData.periode || !formData.templateId">
                    Lanjutkan
                  </button>
                </div>
              </form>
            ...
            <div class="card-body">
              <div class="row mb-4">
                <div class="col-md-6">
                  ...
                  <h6>Tanggal Generate: {{ formatDate(new Date().toISOString()) }}</h6>
                </div>
          ...
          <Card3 colClass="col-sm-12" table="true" headerTitle="true" title="Riwayat Generate Payroll" cardhaderClass="card-no-border">
            <div class="table-responsive theme-scrollbar">
              <table class="display table dataTable no-footer table-bordered">
                ...
                <tbody v-else>
                  <tr v-for="(payroll, index) in sortedGeneratedPayrolls" :key="payroll.id">
                    <td>{{ index + 1 }}</td>
  ...
  import { formData, months } from './data'
  ...
  const sortedGeneratedPayrolls = computed(() => {
    return [...pegawaiStore.generatedPayrolls].sort((a, b) => {
