<template>
              ...
              <form @submit.prevent="previewSlipGaji">
                <div class="row">
                  <div class="col-md-4 mb-3">
                    ...
                    <div class="invalid-feedback" v-if="formSubmitted && !formData.periode">
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <div class="invalid-feedback" v-if="formSubmitted && !formData.pegawaiId">
  ...
  function previewSlipGaji() {
    ...
    if (isValid && formData.value.periode && formData.value.pegawaiId) {
      const payrollId = parseInt(formData.value.periode.toString());
      const pegawaiId = parseInt(formData.value.pegawaiId.toString());
